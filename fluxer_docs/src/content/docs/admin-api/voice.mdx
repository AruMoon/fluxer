...
| country_codes | array[string] | ISO 3166-1 alpha-2 country codes routed to this region (max 249) |
...
| country_codes? | array[string] | ISO 3166-1 alpha-2 country codes routed to this region (max 249, default empty) |
